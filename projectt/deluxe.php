...
<body>
  ...
  <h2>Deluxe Room</h2>
  <div class="room-info">
    <img src="./img/room6.jpg" alt="Deluxe Room">
    <div class="room-details">
      <h3>Description</h3>
      <p style="margin-bottom: 15px;">Experience luxury in our deluxe rooms. Thoughtfully designed with modern comforts and elegant décor, these spacious retreats offer a serene escape. Unwind in style and indulge in comfort, promising a stay that exceeds expectations.</p>
      ...
      <p><b style="color: grey;">Starting at $300 per night</b></p>
